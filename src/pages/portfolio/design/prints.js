...
const PrintsPage = ({ intl: { messages } }) => (
  <StaticQuery
    query={graphql`
      query PrintsPage {
        allStrapiWork(
    ...
    render={data => (
      <Layout>
        <SEO
          title={messages.static.views.portfolio.design.prints.seo_title}
          description={
            messages.static.views.portfolio.design.prints.seo_description
          }
          keywords={messages.static.views.portfolio.design.prints.seo_keywords}
        />
...
export default injectIntl(PrintsPage)
